...
userRouter.post('/register', endpointSecurity({ maxRequests: 50, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), registerUserController)
userRouter.post('/register-retailer', endpointSecurity({ maxRequests: 30, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), shiprocketAddressValidation, registerRetailerController)
...
userRouter.post('/authWithGoogle', endpointSecurity({ maxRequests: 50, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), authWithGoogle)
userRouter.get('/logout',auth,logoutController);
userRouter.post('/admin-login', endpointSecurity({ maxRequests: 50, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), loginAdminController)
...
userRouter.post('/forgot-password', endpointSecurity({ maxRequests: 50, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), forgotPasswordController)
...
userRouter.post('/reset-password', endpointSecurity({ maxRequests: 50, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), resetpassword)
userRouter.post('/forgot-password/change-password', endpointSecurity({ maxRequests: 50, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), changePasswordController)
