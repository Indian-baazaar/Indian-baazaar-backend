...
bannerList2Router.post('/uploadImages',  upload.array('images'), uploadImages);
bannerList2Router.post('/add', addBanner);
bannerList2Router.get('/', getBanners);
bannerList2Router.get('/:id', getBanner);
bannerList2Router.delete('/deteleImage', removeImageFromCloudinary);
bannerList2Router.delete('/:id', deleteBanner);
bannerList2Router.put('/:id', updatedBanner);
