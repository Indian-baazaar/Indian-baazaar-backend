...
router.put('/sellers/approve/:sellerId', endpointSecurity({ maxRequests: 20, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), approveSellerController);
router.put('/sellers/reject/:sellerId', endpointSecurity({ maxRequests: 20, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), rejectSellerController);
router.put('/sellers/status/:sellerId', endpointSecurity({ maxRequests: 20, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), toggleSellerStatusController);
...
router.post('/category', endpointSecurity({ maxRequests: 20, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), createCategory);
...
router.delete('/category/:id', endpointSecurity({ maxRequests: 20, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), deleteCategory);
