...
productRouter.post('/create', checkRetailerBankDetails, adminAuth, endpointSecurity({ maxRequests: 10, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), createProduct);
...
productRouter.post('/productRAMS/create', adminAuth, endpointSecurity({ maxRequests: 10, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), createProductRAMS);
productRouter.delete('/productRAMS/:id', adminAuth, endpointSecurity({ maxRequests: 10, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), deleteProductRAMS);
productRouter.put('/productRAMS/:id', adminAuth, endpointSecurity({ maxRequests: 10, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), updateProductRam);
productRouter.get('/productRAMS/get', getProductRams);
productRouter.get('/productRAMS/:id', getProductRamsById);

productRouter.post('/productWeight/create', adminAuth, endpointSecurity({ maxRequests: 10, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), createProductWEIGHT);
productRouter.delete('/productWeight/:id', adminAuth, endpointSecurity({ maxRequests: 10, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), deleteProductWEIGHT);
productRouter.put('/productWeight/:id',adminAuth, endpointSecurity({ maxRequests: 10, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), updateProductWeight);
productRouter.get('/productWeight/get', getProductWeight);
productRouter.get('/productWeight/:id', getProductWeightById);


productRouter.post('/productSize/create',adminAuth, endpointSecurity({ maxRequests: 10, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), createProductSize);
productRouter.delete('/productSize/:id',adminAuth, endpointSecurity({ maxRequests: 10, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), deleteProductSize);
productRouter.put('/productSize/:id',adminAuth, endpointSecurity({ maxRequests: 10, windowMs: 15 * 60 * 1000, blockDurationMs: 3600000 }), updateProductSize);
